import { getGlyphLayoutHeight, getGlyphOffsetX, getGlyphOffsetY, getKerningOffset, getOffsetToNextGlyph, getOffsetToNextLine, } from '../utils.js';
import { buildGlyphLayout } from './measure.js';
export function buildPositionedGlyphLayout(properties, availableWidth, availableHeight, textAlign, verticalAlign) {
...
export function getTextXOffset(availableWidth, nonWhitespaceWidth, textAlign) {
    switch (textAlign) {
        case 'right':
...
export function getTextYOffset(layout, verticalAlign) {
...
export function getWhitespaceWidth({ font, fontSize }) {

...
description: Worker duties on a Bridge Commander card — the worktree you own and the two verbs that reach the board. Use when a card brief tells you to load it, or when you are working a card and need to signal (a milestone, a blocker, a ruling you need) or report done.
---
...
turn that ends on it looks like a hung worker.
...
## Putting an image in front of the captain

Three ways depending on where it goes: read `images.md`.
